...
const Ticket: React.FC<ITicketProps> = ({
  ...
  return (
    <div className="md:overflow-visible overflow-clip mt-6 md:mt-2 relative md:w-[550px] w-[350px] md:h-[250px] h-[200px]">
      <div className="absolute flex flex-col justify-between w-full h-full px-4 py-4 md:px-6 md:top-2">
        <div className="flex flex-col items-start gap-2 md:gap-4">
          <img className="w-[50%]" alt="Coding Conf Logo" src={fullLogo} />
          <span className="text-light-gray">Jan 31, 2025 / Austin, TX</span>
        </div>

        <div className="flex items-center mb-8 md:mb-2 md:items-start text-start">
          <img
            src={avatar!}
        ...
        <span className="absolute pb-12 pr-8 text-4xl transform rotate-90 -translate-y-1/2 md:right-0 -right-4 opacity-70 top-1/2">
          {ticketCode}
        </span>
      </div>
